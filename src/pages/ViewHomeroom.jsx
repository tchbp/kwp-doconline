...
const ViewHomeroom = () => {
  ...
  useEffect(() => {
    setStudentClass(contextObj.dataLogin.advice);
    form.setFieldsValue({ tclass: contextObj.dataLogin.advice });
  }, []);
